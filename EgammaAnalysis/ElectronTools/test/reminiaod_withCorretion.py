...
process.RandomNumberGeneratorService = cms.Service("RandomNumberGeneratorService",
                                                   ...
                                                   mix = cms.PSet( initialSeed = cms.untracked.uint32(81),
                                                                   engineName = cms.untracked.string('TRandom3')
                                                                   )
                                                   )
...
process.EGMSmearer = cms.Path(process.calibratedPatElectrons)

# Schedule definition
process.schedule = cms.Schedule(process.EGMSmearer,process.endjob_step,process.MINIAODSIMoutput_step)
